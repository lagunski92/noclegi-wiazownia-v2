      ...
      <div className="ml-72 title-mobile">
        ...
        <Slide autoplay={false}>
            <div className="each-slide-effect">
                <div className="flex" style={{flexDirection: "column", alignItems:"center", width: 267}}>
                    <p><img src={Sprzatanie} alt="standart" style={{width: 110, marginBottom:10}}/></p>
                    <p style={{fontWeight: 600}}>REGULARNE SPRZĄTANIE</p>
                    <p style={{textAlign: "center", marginBottom: 10}}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci consequuntur dignissimos.</p>
                </div>
            </div>
            <div className="each-slide-effect">
                <div className="flex" style={{flexDirection: "column", alignItems:"center", width: 267}}>
                    <p><img src={Standart} alt="standart" style={{width:245, marginBottom:10}}/></p>
            ...
            <div className="each-slide-effect">
                <div className="flex" style={{flexDirection: "column", alignItems:"center", width: 267}}>
                    <p><img src={Mapa2} alt="standart" style={{width: 110, marginBottom:10}}/></p>
                    <p style={{fontWeight: 600, marginBottom: 10}}>ŚWIETNA LOKALIZACJA</p>
                    <p style={{textAlign: "center", marginBottom: 60}}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci consequuntur dignissimos.</p>
                </div>
            </div>
        </Slide>:
