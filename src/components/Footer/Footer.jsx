    ...
    <>
      {!isKontaktPage && (
        <div className="main-title mt-16">
          <h3 style={{ marginLeft: 45 }}>Kontakt</h3>
        </div>
      )}
          ...
          (!isMobile ? (
            <div className="kontakt-links">
              ...
              <div className="mail-footer">
                <a href="mailto: mojakwatera@gmail.com">
                  mojakwatera@gmail.com
                </a>
              </div>
            ...
            <div className="flex flex-col ml-5 mt-7">
              ...
              <p className="mail-mobile">
                <a href="mailto: mojakwatera@gmail.com">
                  mojakwatera@gmail.com
                </a>
              </p>
              <p className="map-mobile mt-3 mb-3">
                <a
                  href="https://goo.gl/maps/yN1SYRfiZGusMv5j8"
                  target="_blank"
                  rel="noreferrer"
              ...
              <div className="flex">
                <p className="facebook-mobile mr-3">
                  <a
                    href="https://www.facebook.com/SuperNocleg"
                    target="_blank"
                    rel="noreferrer"
